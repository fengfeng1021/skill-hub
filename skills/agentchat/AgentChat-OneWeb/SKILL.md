...
- ChatGPT quota is known to be exhausted and a fallback is needed
...
```
ChatGPT → Gemini → Claude → Qwen → Kimi → MiniMax → MiMo → DeepSeek
(首选)    (Pro Extended)                                    (last resort)
```
