 ...
 *
 * Priority chain: ChatGPT → Gemini (Pro Extended) → Claude → Qwen → Kimi → MiniMax → MiMo → DeepSeek
...
const PROVIDER_KEYS = ['chatgpt','gemini','claude','qwen','kimi','minimax','mimo','deepseek'];
