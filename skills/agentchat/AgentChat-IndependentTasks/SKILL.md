...
N 道独立任务，M 个能力等同的 AI（最多 7：chatgpt/gemini/qwen/kimi/minimax/mimo/deepseek），纯分发、零协作。
...
```json
{
  ...
  "subtasks": [
    {
      "id": "STE-size", "primary": "chatgpt", "depends_on": [],
      "questions": ["R1Q1", "R2Q1"]
    }
  ],
  "questionBank": {
...
```json
{
  ...
  "subtasks": [
    {
      "id": "group_x", "primary": "chatgpt", "depends_on": [],
